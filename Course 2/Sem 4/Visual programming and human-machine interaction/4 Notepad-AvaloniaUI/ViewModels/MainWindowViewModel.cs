...
using VpHw_4.Models;
using static VpHw_4.Models.FileTypes;
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private void LoadDir()
        {
            ...
            foreach (var name in files)
                fileList.Add(new FileItem(FILE, name));
        }
        ...
        public MainWindowViewModel()
        {
            ...
            Save = ReactiveCommand.Create<Unit, Unit>(_ =>
            {
                FuncSave();
                return new Unit();
            });
            Ok = ReactiveCommand.Create<Unit, Unit>(_ =>
            {
                FuncOk();
                return new Unit();
            });
            Cancel = ReactiveCommand.Create<Unit, Unit>(_ =>
            {
                FuncCancel();
                return new Unit();
            });
